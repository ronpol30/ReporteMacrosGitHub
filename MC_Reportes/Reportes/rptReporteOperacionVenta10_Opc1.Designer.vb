...
Partial Public Class rptReporteOperacionVenta10_Opc1
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(rptReporteOperacionVenta10_Opc1))
        ...
        Me.XrLabel2.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "MCRM_UneBD_ReporteOperacionVenta10_Opc1.RAZONCOMERCIAL")})
        ...
        Me.XrLabel7.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "MCRM_UneBD_ReporteOperacionVenta10_Opc1.APELLIDOS", "{0:dd/MM/yy H:mm}")})
        ...
        Me.XrLabel6.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "MCRM_UneBD_ReporteOperacionVenta10_Opc1.tdocumento")})
        ...
        Me.XrLabel9.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "MCRM_UneBD_ReporteOperacionVenta10_Opc1.PEDIDO", "{0:dd/MM/yyyy}")})
        ...
        Me.XrLabel12.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "MCRM_UneBD_ReporteOperacionVenta10_Opc1.fecharegistro", "{0:dd/MM/yyyy hh:mm tt}")})
        ...
        Me.XrLabel10.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "MCRM_UneBD_ReporteOperacionVenta10_Opc1.PRODUCTO", "{0:dd/MM/yyyy}")})
        ...
        Me.XrLabel30.SizeF = New System.Drawing.SizeF(163.4739!, 41.48666!)
        ...
        'XrLabel3
        '
        Me.XrLabel3.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "MCRM_UneBD_ReporteOperacionVenta10_Opc1.AREA", "{0:dd/MM/yy H:mm}")})
        ...
        Me.XrLabel4.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "MCRM_UneBD_ReporteOperacionVenta10_Opc1.RAZONSOCIAL")})
        ...
        Me.XrLabel11.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "MCRM_UneBD_ReporteOperacionVenta10_Opc1.PRECIO", "{0:c2}")})
        ...
        Me.XrLabel8.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "MCRM_UneBD_ReporteOperacionVenta10_Opc1.NOMBRES", "{0:dd/MM/yy H:mm}")})
        ...
        Me.XrLabel5.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "MCRM_UneBD_ReporteOperacionVenta10_Opc1.empresa", "{0:d/MM/yyyy HH:mm}")})
        ...
        StoredProcQuery3.Name = "MCRM_UneBD_ReporteOperacionVenta10_Opc1"
        ...
        StoredProcQuery3.StoredProcName = "MCRM_UneBD_ReporteOperacionVenta10_Opc1"
        ...
        '
        'rptReporteOperacionVenta10_Opc1
        '
        ...
        Me.DataMember = "MCRM_UneBD_ReporteOperacionVenta10_Opc1"
