...
Public Class opciReporteOperacionVenta3
    Public Sub New()
        ' This call is required by the designer.
        InitializeComponent()
        'Se inicializa los controles
        Me.Text = "REPORTE DE ANULACIONES - " '& SistemaDAO.NombreLocal
    ...
    Private Sub EmitirAnuladoPedidos()
        ...
        RPT.DataSource = ReportesDao.ReporteOperacionVenta3_Opc2(sLista, (DateIni.Text + " " + TimeIni.Text), (DateFin.Text + " " + TimeFin.Text))
    ...
    End Sub
    ''corden butonn
    Private Sub EmitirAnuladoDocumentos()
        Dim sLista As String = ""
        Me.GridView1.PostEditor()
        Me.GridView1.CloseEditor()
        Me.GridView1.UpdateCurrentRow()
        Dim RPT As New rptReporteOperacionVenta3_Opc1
        ...
        RPT.DataSource = ReportesDao.ReporteOperacionVenta3_Opc1(sLista, (DateIni.Text + " " + TimeIni.Text), (DateFin.Text + " " + TimeFin.Text))
        RPT.DataMember = "Reporte"
